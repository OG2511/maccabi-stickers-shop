  ...
  return (
    ...
    >
      <div className="relative">
        {/* Main button - removed pulse animation */}
        <div className="bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-lg transition-all duration-300 transform hover:scale-110 active:scale-95">
          {/* WhatsApp icon using SVG for better quality */}
